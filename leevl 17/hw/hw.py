...
list1 = ["car", "plane", "phone", "keyboard", "mouse"]
i = list1.index("car")
print(i)
...
food = ["mwvadi", "xachapuri", "xinkali", "lobiani", "borshi", "shaurma", "chaqafuli", "burgeri", "pizza", "gomi"]
for i in range(10):
    print(food[i])
...
# Dont remember how to do that sorry <3
